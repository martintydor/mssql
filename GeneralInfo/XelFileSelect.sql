...
--
--Description:
--Returns detailed info from XEL file stored on storage account blob
...
from sys.fn_xe_file_target_read_file('https://StorageAccountName.blob.core.windows.net/Folder/FileName.xel', null, null, null)) ed
